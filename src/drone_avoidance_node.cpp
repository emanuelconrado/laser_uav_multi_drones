...
/* on activate() //{ */
CallbackReturn DroneAvoidance::on_activate(
...
/* on deactivate() //{ */
CallbackReturn DroneAvoidance::on_deactivate(
    [[maybe_unused]] const rclcpp_lifecycle::State &state) {
...
/* on cleanup() //{ */
CallbackReturn
DroneAvoidance::on_cleanup([[maybe_unused]] const rclcpp_lifecycle::State &state) {
...
/* on shutdown() //{ */
CallbackReturn DroneAvoidance::on_shutdown(
    [[maybe_unused]] const rclcpp_lifecycle::State &state) {
...
void DroneAvoidance::configure_timers() {
  ...
  timer_manager_ = create_wall_timer(
      ...
      std::bind(&DroneAvoidance::timer_manager_callback, this), nullptr);
}
//}
